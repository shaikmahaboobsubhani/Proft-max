...
--><li class="nav-item">
                        ...
                        <li class="nav-item">
                                <a class="nav-link" href="CloudUserRegistration.jsp">CloudUserRegistration</a>
                        </li>
                         <li class="nav-item">
                                <a class="nav-link" href="BrokerRegistration.jsp">BrokerRegistration</a>
                        </li>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <article>
                        ...
                        <p>Welcome to portal, a free CSS3 &amp; HTML5 responsive web template from <a href="https://zypopwebtemplates.com/" title="ZyPOP">ZyPOP</a>. This template is completely <strong>free</strong> to use permitting a link remains back to  <a href="https://zypopwebtemplates.com/" title="ZyPOP">https://zypopwebtemplates.com/</a>.</p>
