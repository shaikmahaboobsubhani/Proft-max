...
<br/><br/>
  ...
  <body>
      ...
      <h3 align="center" style="color: #cc0066">Profit Details</h3>
...
<th style="text-align: center;color: #99004d">Total Cloud Price</th>
<th style="text-align: center;color: #99004d">Total Broker Price</th>
...
<%
  ...
  Connection con = dc.getConnection();
    ...
    PreparedStatement st1=con.prepareStatement("select REQUEST.machines,REQUEST.quantity,PRODUCTDETAILS.price,REQUEST.quantity*PRODUCTDETAILS.price from REQUEST ,PRODUCTDETAILS where REQUEST.machines=PRODUCTDETAILS.machines and  REQUEST.status='ACCEPTED'");
...
<td><%=(Integer.parseInt(rs1.getString("quantity")))*(Integer.parseInt(rs1.getString("price"))) %></td>
