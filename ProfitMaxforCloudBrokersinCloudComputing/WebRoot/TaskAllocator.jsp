...
<br/><br/>
  ...
  <form action="ViewUpdateRequestDetails.jsp">
  
  
      <h3 align="center" style="color: #cc0066">View Task Allocation Details</h3>
...
--><!--<th style="text-align: center;color: #99004d">Message</th>
...
ArrayList<ProductBean> al=dao.viewTaskAllocator();
