...
<div id="container">
  <div id="container_body">
    <div>
      <h2 class="form_title">Cloud User Registration </h2>
    ...
    <div id="form_name">
      <div class="firstnameorlastname">
       ...
       <form   action="./RegisterServlet" name="myform" onsubmit="return validator();">
      ...
      <div class="useridorphone">
       <div id="errorBox"></div>
        ...
        <input type="text" name="userid" pattern="[a-zA-Z]{3,}" value=""  placeholder="Username" class="input_name">
         <input type="text" name="phone" value=""  minlength="10" maxlength="10" pattern="\d{10}" placeholder="Phone" class="input_phone">
      </div>
      <div id="email_form">
