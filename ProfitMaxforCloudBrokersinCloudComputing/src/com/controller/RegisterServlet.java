...
String target = "CloudUserRegistration.jsp?status=Registration Failed  !!!!!";
boolean flag1=new ProfileDAO().checkLoginIDExisted(request.getParameter("uid"));
if(flag1==true){
	 target = "CloudUserRegistration.jsp?status=This "+flag1+" login ID is not present!!";
}
else{
	...
	target = "Login.jsp?status=Welcome Account is created successfully";
		...
		target = "CloudUserRegistration.jsp?status=Registration Failed  !!!!!";	
	}
}
